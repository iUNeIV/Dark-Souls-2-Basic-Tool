...
Public Class SimplaTheme : Inherits ContainerControl
    ...
    Protected Overrides Sub OnPaint(ByVal e As System.Windows.Forms.PaintEventArgs)
        ...
        G.SetClip(Draw1.RoundRect(New Rectangle(0, 0, Width, Height), 9))
    ...
    Protected Overrides Sub OnPaint(ByVal e As System.Windows.Forms.PaintEventArgs)
        ...
        Select Case ColorScheme
            Case ColorSchemes.DarkGray
                ...
                G.FillPath(gradientBackground, Draw1.RoundRect(ClientRectangle, 4))

                Dim p As New Pen(New SolidBrush(Color.FromArgb(56, 56, 56)))
                G.DrawPath(p, Draw1.RoundRect(ClientRectangle, 4))

                Dim p2 As New Pen(New SolidBrush(Color.FromArgb(5, 240, 240, 240)))
                G.DrawPath(p2, Draw1.RoundRect(InnerRectangle, 4))
...
#End Region
    ...
    Protected Overrides Sub OnPaint(ByVal e As System.Windows.Forms.PaintEventArgs)
        ...
        G.DrawPath(New Pen(New SolidBrush(Color.FromArgb(26, 26, 26))), Draw1.RoundRect(New Rectangle(1, 1, Width - 3, Height - 3), 2))
        ...
        If Not intValue = 0 Then
            Select Case ColorScheme
                Case ColorSchemes.DarkGray
                    ...
                    G.FillPath(g1, Draw1.RoundRect(New Rectangle(2, 2, intValue - 5, Height - 5), 2))
        ...
        '//// Outer Rectangle
        G.DrawPath(New Pen(Color.FromArgb(190, 56, 56, 56)), Draw1.RoundRect(New Rectangle(0, 0, Width - 1, Height - 1), 2))

        '//// Bar Size
        G.DrawPath(New Pen(Color.FromArgb(150, 97, 94, 90)), Draw1.RoundRect(New Rectangle(2, 2, intValue - 5, Height - 5), 2))
...
Public Class SimplaTabControl : Inherits TabControl
    ...
    Protected Overrides Sub OnPaint(e As PaintEventArgs)
        ...
        If Not SelectedIndex = -1 Then
            ...
            G.FillPath(New SolidBrush(activeTabColor), Draw1.RoundRect(TabRect, 4))
            G.DrawPath(New Pen(New SolidBrush(Color.FromArgb(20, 20, 20))), Draw1.RoundRect(TabRect, 4))
